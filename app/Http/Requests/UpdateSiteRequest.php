...
class UpdateSiteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // "Most read" popularity: which source feeds it + refresh cadence.
            'settings.popularity' => ['sometimes', 'array'],
            'settings.popularity.enabled' => ['sometimes', 'boolean'],
            'settings.popularity.source' => ['sometimes', 'in:pixel,ga,cloudflare'],
            'settings.popularity.cadence' => ['sometimes', 'in:daily,weekly'],
            'settings.popularity.window_days' => ['sometimes', 'integer', 'min:1', 'max:90'],
            'settings.popularity.count' => ['sometimes', 'integer', 'min:1', 'max:50'],
            'settings.popularity.ga' => ['sometimes', 'array'],
            'settings.popularity.cloudflare' => ['sometimes', 'array'],
