...
class HeroBlockDefinition implements BlockDefinition
{
    ...
    public function validationRules(): array
    {
        return [
            ...
            'contentMaxWidth'   => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],

            // Typography fields
            'headlineSize'      => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            ...
            'subheadlineSize'   => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            ...
            'responsive.tablet.contentMaxWidth' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            'responsive.tablet.headlineSize'    => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            'responsive.tablet.subheadlineSize' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            ...
            'responsive.mobile.contentMaxWidth' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            'responsive.mobile.headlineSize'    => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
            'responsive.mobile.subheadlineSize' => ['sometimes', 'nullable', 'string', 'max:20', 'regex:/^(0|\d+(\.\d+)?(px|rem|em|%|vh|vw))$/'],
