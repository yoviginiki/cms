...
export const HeroPreview: React.FC<BlockComponentProps> = ({ block, isSelected, onUpdate }) => {
  ...
  const contentMaxWidth = safeDim(rv('contentMaxWidth', '800px')) || '800px';
  const headlineSize = safeDim(rv('headlineSize', '2.5rem')) || '2.5rem';
  ...
  const subheadlineSize = safeDim(rv('subheadlineSize', '1.25rem')) || '1.25rem';
