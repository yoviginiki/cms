...
export const MenuPreview: React.FC<BlockComponentProps> = ({ block }) => {
  ...
  return (
    <nav style={navStyle}>
      <div style={{ display: 'flex', alignItems: isVertical ? 'flex-start' : 'center', flexDirection: isVertical ? 'column' : 'row', gap: isVertical ? '0.5rem' : itemGap, justifyContent: 'space-between' }}>
