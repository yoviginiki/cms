...
import { Plus, Edit, Trash2, Newspaper, Loader2, Filter } from 'lucide-react';
import { posts, categories as categoriesApi } from '@/lib/api';
...
export default function PostsList() {
  ...
  const { data, isLoading, error } = useQuery<Post[]>({
    queryKey: ['posts', siteId, statusFilter, categoryFilter],
    queryFn: () => {
                ...
                <tr key={post.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() => navigate(`/sites/${siteId}/posts/${post.id}/edit`)}
