...
function makeDefaultElement(
  ...
  const defaultData: Record<string, Record<string, unknown>> = {
    ...
    footnote_frame: { content: '<p>Footnote</p>', overflow: 'hidden', autoSize: 'none', columnsInFrame: 1, columnGap: 12, columnRule: false, textInset: { top: 4, right: 4, bottom: 4, left: 4 }, verticalAlign: 'top' },
    marginalia_frame: { content: '<p>Side note</p>', overflow: 'hidden', autoSize: 'none', columnsInFrame: 1, columnGap: 12, columnRule: false, textInset: { top: 4, right: 4, bottom: 4, left: 4 }, verticalAlign: 'top' },
