...
class TestimonialValidationTest extends TestCase
{
    private TestimonialBlockDefinition $def;
    private array $rules;

    protected function setUp(): void
    {
        parent::setUp();
        $this->def = new TestimonialBlockDefinition();
    ...
    {
        $this->assertEquals('testimonial', $this->def->type());
    }
    ...
    {
        $this->assertTrue($this->validate(['layout' => 'single'])->passes());
    }
