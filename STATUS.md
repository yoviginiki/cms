...
|---|---|---|---|
| RenderMode + `sp_editable()` (Phase 1 + rollout) | Complete | 9/10 | 10 блока (heading/rich-text/image/paragraph/text/pullquote/button/hero/ctabanner/sidenote); останалите ~91 partial-а нямат атрибути |
