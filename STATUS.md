...
|---|---|---|---|
| RenderMode + `sp_editable()` (Phase 1 + rollout) | Complete | 9/10 | 16 блока (…/runningtext/imagecaption/newsletter/paywall/chart/video); останалите ~85 partial-а нямат атрибути |
